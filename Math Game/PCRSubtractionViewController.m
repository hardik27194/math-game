//
//  PCRSubtractionViewController.m
//  Math Game
//
...
@interface PCRSubtractionViewController ()
...
@implementation PCRSubtractionViewController
...
-(void)newQuestion
{
    ...
    PCRMathPlayingGame *game = [[PCRMathPlayingGame alloc] initWithType:@"Subtraction"];
    ...
    if (self.buttonOne.selected) {
        //             if ([self.buttonOne.titleLabel.text isEqualToString:textOne]) {
        UIAlertController *alertController = [UIAlertController
                                              alertControllerWithTitle:@"Good Job!"
                                              message:nil
                                              preferredStyle:UIAlertControllerStyleAlert];
